...
class MapController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController
{
	...
	public function indexAction()
	{
		...
		$wtfMappingFields = ['mapwidth', 'mapheight', 'addresslist', 'start_zoom', 'detail_zoom', 'center_coordinates', 'noclusterer'];
		...
		$_noclusterer = $noclusterer ? 'false' : 'true';
